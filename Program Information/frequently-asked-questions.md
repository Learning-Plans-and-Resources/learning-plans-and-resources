...
## Is there an communication application to download

The GADS 2021 program is only using the Andela Learning Community web application. This platform will be the only communication form for the program

## How can I download the pluralsight offline app

To download the Pluralsight offline application got to [Pluralsight Downloads](https://www.pluralsight.com/product/downloads). There you will find links to install the offline app for your device, computer or mobile phone.

## How to synchronise the Pluralsight offline app with the Pluralsight web app

To synchronise the Pluralsight offline app. Launch or use the offline app while connected to the internet. This will synchronise your offline viewing with your account and  will make modules appear as "viewed" on your account.
